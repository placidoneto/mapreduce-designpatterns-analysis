...
\end{figure}
 ...
 \centering 
  \subfloat[\textit{Ebooks} Data]
  {\label{fig:pisp6}\includegraphics[width=0.471\textwidth]{figs/analysis-charts/hadoop/ebooks.png}}   
  \subfloat[\textit{Tex} Data]
  ...
  \\
  \subfloat[\textit{Serverfault} Data]
  {\label{fig:pisp6}\includegraphics[width=0.5\textwidth]{figs/analysis-charts/hadoop/serverfault.png}}   
  \subfloat[\textit{Wordpress} Data]
  {\label{fig:pisp7}\includegraphics[width=0.49\textwidth]{figs/analysis-charts/hadoop/wordpress.png}}
   %add desired spacing between images, e. g. ~, \quad, \qquad etc. (or a blank line to force the subfig onto a new line)
  %~
  \\
  \subfloat[\textit{Webapps} Data]
