...
computation issues, without being specific to the problem domain, as 
traditional software engineering design patterns do. 
  
\ldots  
  
We analyze the application areas of mapreduce design patterns and their possible
gaps. We found that the use of combined and more effective use of patterns in big data analysis
can provide a more performative result. Thus, from case studies, we present a set design patterns
composite and application of results.      
