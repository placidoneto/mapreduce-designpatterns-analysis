...
the execution and analysis of tree group of patterns \cite{}: (i)
summarization, (ii) filtering and join patterns. The patterns were
implemented and executed using Pig latin \cite{} and Hadoop \cite{}. We
presented and discussed the results to compare the
diferences between their behavior and know the
advantages and disadvantages of each environment. Likewise, we also
performed a Systematic Mapping \cite{} concerning the use and composition of
these patterns to understand the way in which they are correlated. 
We expressed and analyzed the results of the Systematic Mapping as bubble
charts. Finally, from these results we introduce a preliminary set of MapReduce
design patterns composition for big data analysis. 
\end{abstract}
...
%\section{Systematic Mapping Process}\label{sec:mappingprocess}
\input{mappingprocess} 

\section{Working with MapReduce Design Patterns}\label{sec:case-study}
\input{execution-analysis} 

\section{Composing MapReduce Design Patterns}\label{sec:composition}
\input{composition-mrdp}
