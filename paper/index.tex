...
computation issues, without being specific to the problem domain, such as the
tradition software engineering design patterns do. 

We proceeded with a systematic mapping (SM) \cite{Budgen:2008,Petersen:2008} to analyze the
application areas of mapreduce design patterns and their possible gaps. We found
that the use of combined and more effective use of patterns in big data analysis
can provide a more performative result. Thus, from case studies, we present a set design patterns
compounds and application of results.      
