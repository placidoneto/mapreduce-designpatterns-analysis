...
charts. Finally, from these results we introduce a unification of the 
MapReduce design patterns for big data analysis. 
\end{abstract}
...
\section{Mapping Process}\label{sec:sysmap}
...
\section{Comparing Design Pattern Execution in Hadoop and
Pig - Quantitative Results}\label{sec:lessons-learned}
